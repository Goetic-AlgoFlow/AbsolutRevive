...
public final class RenderStateExtensions {
   public static final RenderStateDataKey<Boolean> PASSENGER = RenderStateDataKey.create(() -> "absolutrevive:passenger");
   public static final RenderStateDataKey<Boolean> UNCONSCIOUS = RenderStateDataKey.create(() -> "absolutrevive:unconscious");
   public static final RenderStateDataKey<Float> COLLAPSE_PROGRESS = RenderStateDataKey.create(() -> "absolutrevive:collapse_progress");
